...
number of steps. The current steps number will increase every 1.5 seconds to simulate taking steps. 
When you select the
...
you select the "Start" button, the seconds value will start counting up, and "Start" will be replaced with "Reset." 
When 
